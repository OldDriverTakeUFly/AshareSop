#!/usr/bin/env python3
"""东材科技 (601208.SH) 单股困境反转评分脚本.

调用 davis_analyzer 核心函数（不改任何源码），对东材科技执行完整四维评分：
...
用法:
    .venv/bin/python davis_analyzer/studies/dongcai_scoring.py

输出:
    .sisyphus/evidence/dongcai/t2-davis-score.json
"""
...
OUTPUT_PATH = Path(".sisyphus/evidence/dongcai/t2-davis-score.json")
...
def score_dongcai() -> dict:
    """执行东材科技完整四维评分，返回 JSON 可序列化的 dict."""

    logger.info("=" * 70)
    logger.info("东材科技 (601208.SH) 戴维斯双击困境反转评分")
    logger.info("=" * 70)
