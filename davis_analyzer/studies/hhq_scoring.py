...
用法:
    ...
    davis_analyzer/studies/hhq_scoring.py

输出: davis_analyzer/studies/hhq_engine_20260830.json
"""
...
STOCK_NAME = "华海清科"
PERIODS = 12
OUTPUT_PATH = Path(__file__).parent / "hhq_engine_20260830.json"
