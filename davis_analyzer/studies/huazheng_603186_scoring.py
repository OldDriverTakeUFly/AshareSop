"""华正新材 603186.SH 研报取数脚本（research-report skill Phase 2）。"""
import os
import sys
...
# ── 9. 最新日线价格 ──
d = pro.daily(ts_code=TS_CODE, limit=10)
print("\n== 最近日线 ==")
print(d[["trade_date", "close", "pre_close", "pct_chg", "vol", "amount"]].to_string())
