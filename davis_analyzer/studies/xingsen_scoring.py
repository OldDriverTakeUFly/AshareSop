#!/usr/bin/env python3
"""兴森科技 (002436.SZ) 单股困境反转评分脚本.

调用 davis_analyzer 核心函数（不改任何源码），对兴森科技执行完整四维评分：
...
用法:
    .venv/bin/python davis_analyzer/studies/xingsen_scoring.py

输出:
    .sisyphus/evidence/xingsen/t2-davis-score.json
"""
...
OUTPUT_PATH = Path(".sisyphus/evidence/xingsen/x2-davis-score.json")
