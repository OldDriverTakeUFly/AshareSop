...
from davis_analyzer.systems.cardgen import ledger, publish_sync
from davis_analyzer.systems.cardgen.builder import load_release, render
from davis_analyzer.systems.cardgen.facts import load_facts, save_facts
...
def cmd_video(args: argparse.Namespace) -> None:
    if args.style == "pro":
        from davis_analyzer.systems.cardgen.video3 import gen_pro_video
        final = gen_pro_video(_project(args.topic), args.topic, voice=args.voice)
    elif args.style == "motion":
        from davis_analyzer.systems.cardgen.video2 import gen_motion_video
        final = gen_motion_video(_project(args.topic), args.topic, voice=args.voice)
    else:
        from davis_analyzer.systems.cardgen.video import gen_video
