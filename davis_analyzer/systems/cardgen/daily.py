...
from davis_analyzer.systems.cardgen.facts import save_facts
from davis_analyzer.systems.cardgen.types import Fact, ValidateReport
...
def fetch_thermo_bundle(day: str) -> dict:
    ...
    try:
        ...
        from davis_analyzer.systems.thermometer.scoring import rotation_signals
