...
def cmd_backfill(args: argparse.Namespace) -> None:
    from davis_analyzer.systems.intraday import backfill
...
def cmd_status(args: argparse.Namespace) -> None:
    from davis_analyzer.systems.intraday import db
...
def cmd_verify(args: argparse.Namespace) -> None:
    ...
    from davis_analyzer.systems.limitup.db import connect as market_connect
...
def cmd_run(args: argparse.Namespace) -> None:
    from davis_analyzer.systems.intraday.engine import IntradayConfig
    from davis_analyzer.systems.intraday.report import run_and_report
...
def cmd_amp_study(args: argparse.Namespace) -> None:
    from davis_analyzer.systems.intraday import amplitude_study
...
def cmd_overnight_study(args: argparse.Namespace) -> None:
    from davis_analyzer.systems.intraday import overnight_study
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(prog="davis_analyzer.systems.intraday")
