...
if TYPE_CHECKING:
    ...
    from davis_analyzer.systems.limitup.backfill import FetchFn
...
def cmd_backfill(args: argparse.Namespace) -> None:
    from davis_analyzer.systems.limitup import backfill, db
...
def cmd_study(args: argparse.Namespace) -> None:
    ...
    from davis_analyzer.systems.limitup import db, patterns, report, study
    from davis_analyzer.systems.limitup.events import build_events
    from davis_analyzer.systems.limitup.robustness import split_is_oos
...
def cmd_backtest(args: argparse.Namespace) -> None:
    ...
    from davis_analyzer.core import config
    from davis_analyzer.systems.limitup import db, engine, patterns, report
...
def cmd_candidates(args: argparse.Namespace) -> None:
    ...
    from davis_analyzer.systems.limitup import candidates, db
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="davis_analyzer.systems.limitup",
...
def cmd_daily(args: argparse.Namespace) -> None:
    from davis_analyzer.systems.limitup import daily_refresh, db
...
def cmd_queue_sim(args: argparse.Namespace) -> None:
    from davis_analyzer.systems.limitup import db, queue_sim
...
def cmd_queue_backfill(args: argparse.Namespace) -> None:
    from davis_analyzer.systems.limitup import db, queue_backfill
