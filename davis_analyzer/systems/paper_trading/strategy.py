...
from davis_analyzer.systems.paper_trading.account import Position, min_buy_lots
    ...
    def evaluate(
        ...
        for code, factors in snapshot.factor_scores.items():
            ...
            if self.enable_negative_factors:
                from davis_analyzer.systems.paper_trading.negative_factors import check_buy as _nf_check_buy
                veto = _nf_check_buy(
        ...
        if self.enable_negative_factors:
            from davis_analyzer.systems.paper_trading.negative_factors import compute_concentration
        ...
        for pos in positions:
            ...
            if self.enable_negative_factors:
                from davis_analyzer.systems.paper_trading.negative_factors import check_holding as _nf_check_holding
...
class BoardChasingStrategy:
    ...
    def _load_candidates(self, trade_date: str) -> pd.DataFrame:
        ...
        from davis_analyzer.systems.limitup import candidates as _limitup_candidates
    ...
    def evaluate(
        ...
        try:
            from davis_analyzer.systems.limitup.candidates import candidate_context
